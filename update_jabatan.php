 ...
 if(isset($_GET['deptID']))
{
  ...
  $deptID = urldecode(secured_decrypt($_GET['deptID']));
...
header("Location: jabatan.php?op=errkod");
}
else
{
  echo "<script>
...
header("Location: jabatan.php?op=success");
...
else if(isset($_POST['padam']))
{
  ...
  header("Location: jabatan.php?del=errkod");
  }
  else
  {
    echo "<script>
  ...
  header("Location: jabatan.php?del=success");
        ...
        <div class="container-fluid">
          ...
          <div class="shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-info">KEMASKINI JABATAN</h6>
            </div>
            <div class="card-body">
            <form name="update_jabatan" class="user" method="post" action = "update_jabatan.php">
            <div class="form-group">
                    <input type="hidden" class="form-control form-control-user" name="deptID" placeholder="ID Jabatan" value="<?php echo $row['deptID']; ?>" required >
            </div>
            <div class="form-group">
                <input type="text" class="form-control form-control-user" name="deptName" placeholder="Nama Jabatan" value="<?php echo $row['deptName']; ?>" required >
            </div>
          </div>
